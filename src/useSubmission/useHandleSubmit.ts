import { useCallback, SyntheticEvent, useReducer, Reducer } from 'react';
import {
  ActionTypes,
  SubmitFeedback,
  Action,
...
export function useHandleSubmit({
  ...
  const { fnc: handleSubmit, invokeCount: submitCount, isRunning: isSubmitting } = useFunctionStats<
